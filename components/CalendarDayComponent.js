...
class CalendarDayComponent extends React.Component {
  ...
  getContentStyle() {
    ...
    if (state === "today") {
      ...
      if (marking.status === "great") style.content.backgroundColor = "green";
      else if (marking.status === "neutral")
        style.content.backgroundColor = "blue";
      else if (marking.status === "bad") style.content.backgroundColor = "red";
      else style.content.backgroundColor = "gray";
